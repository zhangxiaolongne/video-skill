...
> **当前开发闸门**：V3-07 Personal/Subject Memory 已作为完整能力版本发布；V3-08 尚未启动。具体执行任务、验收和发布状态分别以 `docs/CURRENT_BATCH.md`、`docs/DEVELOPMENT_PROGRESS.md`、`docs/RELEASES.md` 与 `docs/current_progress.json` 为准。
...
当前已发布 gate 是 `V3-07 Personal/Subject Memory`；`V3-08 V3 Release` 尚未启动。母版只记录战略边界：
