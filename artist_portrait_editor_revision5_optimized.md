...
> **当前开发闸门**：V3-06 Publishability Tiers，已作为一个完整能力版本发布；V3-07 尚未启动。具体执行任务、验收和发布状态分别以 `docs/CURRENT_BATCH.md`、`docs/DEVELOPMENT_PROGRESS.md`、`docs/RELEASES.md` 与 `docs/current_progress.json` 为准。
...
当前 active gate 是 `V3-06 Publishability Tiers`；`V3-05 NLE Round-Trip Plus` 已发布。母版只记录战略边界：
