...
> **当前开发闸门**：V2-10 Real Video Benchmark Pack，本地已完成、等待作为一个完整版本发布。V2-09 已发布；V2-11 尚未启动。具体执行任务、验收和发布状态分别以 `docs/CURRENT_BATCH.md`、`docs/DEVELOPMENT_PROGRESS.md`、`docs/RELEASES.md` 与 `docs/current_progress.json` 为准。
...
当前 active gate 是 `V2-10 Real Video Benchmark Pack`；`V2-09 Second-Cut Candidate Generation` 已发布。母版只记录战略边界：
