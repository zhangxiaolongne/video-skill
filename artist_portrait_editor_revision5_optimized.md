...
> **当前开发闸门**：V2-07 Text, Subtitle, And On-Screen Timing Plan，本地已完成、等待作为一个完整版本发布。V2-06 已发布；V2-08 尚未启动。具体执行任务、验收和发布状态分别以 `docs/CURRENT_BATCH.md`、`docs/DEVELOPMENT_PROGRESS.md`、`docs/RELEASES.md` 与 `docs/current_progress.json` 为准。
...
当前 active gate 是 `V2-07 Text, Subtitle, And On-Screen Timing Plan`；`V2-06 BGM Mood And Rhythm Matching` 已发布。母版只记录战略边界：
