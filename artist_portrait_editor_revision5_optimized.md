...
> **当前开发闸门**：V3-08 V3 Release 已作为 `v0.50.0` 发布；V4-01 尚未启动。具体执行任务、验收和发布状态分别以 `docs/CURRENT_BATCH.md`、`docs/DEVELOPMENT_PROGRESS.md`、`docs/RELEASES.md` 与 `docs/current_progress.json` 为准。
...
当前已发布 gate 是 `V3-08 V3 Release`（`v0.50.0`）；V4-01 尚未启动。母版只记录战略边界：
