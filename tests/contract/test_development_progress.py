...
def test_machine_readable_progress_matches_current_dashboard():
    ...
    assert "Transcript / Vision / Audio Evidence Fusion" in progress
    assert payload["tasks"][0]["id"] == "canonical_map"
