...
def test_machine_readable_progress_matches_current_dashboard():
    ...
    assert "First-Cut Aesthetic Self-Review" in progress
    assert payload["tasks"][0]["id"] == "canonical_review"
