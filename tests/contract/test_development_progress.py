...
def test_machine_readable_progress_matches_current_dashboard():
    ...
    assert "BGM Mood And Rhythm Matching" in progress
    assert payload["tasks"][0]["id"] == "canonical_match"
