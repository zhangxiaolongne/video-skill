...
foundation work only. The active gate is V0-010m proposal execution readiness plan:
...
-> deterministic proposal execution approval record packet
-> deterministic proposal execution readiness plan packet
