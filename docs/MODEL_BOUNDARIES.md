...
The current V0-010a proposal readiness gate performs no remote model calls.
...
currently records readiness or blocked state only. None of these are creative
