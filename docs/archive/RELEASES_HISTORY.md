...
- Capability gate: `V1-08`
- Active local batch: `V1-08 Revision promotion, revised render readiness, and V1 release packaging`
- Current release marker: published `v0.29.0`
- Release date: `2026-07-04`
- Release commit subject: `Release artist portrait editor v0.29.0`
...
- Completed in release `v0.24.0`: V0-010n through V0-010t, V0-010 foundation
  ...
  V0-023, and V0-024
- Release target: `v0.29.0` completed
...
- Completed in release `v0.28.0`: V0-044, V0-045, V0-046, V0-047, V0-048,
  ...
  ACCEPTANCE-STAGE-06
- Completed in release `v0.29.0`: V1-01 duration decision/edit-brief, V1-02
  clip scoring/content-understanding evidence, V1-03 aesthetic timeline draft,
  V1-04 sound/BGM decision, V1-05 cut review, V1-06 revision loop, V1-07
  controlled revision application, and V1-08 revision promotion/release
  packaging
- Working-tree publication state: source tree published as `v0.29.0`; local
  `runs/` real-project evidence remains visible and intentionally untracked
...
- Latest published capability release tag: `v0.29.0`
- Remote freshness: peeled `v0.29.0` verified at
  `fb723b2d13114b5b2885a19c1a06bdccd4cf02ca` after push; annotated tag object
  `84ab1f9cc60e1445447badd6858a62031b57133c`; remote `main` received the
  release commit and this follow-up publication ledger without moving the tag
...
- Published V1 index: V1-03 aesthetic timeline, V1-04 sound/BGM decision,
  V1-05 cut review, V1-06 revision loop, V1-07 revision application, and
  V1-08 revision promotion/release packaging are included in `v0.29.0`.

## Current Validation

Validation is updated only after the complete current working tree passes.

- Verified: V1-08 release-candidate validation passed on `2026-07-04`;
  `v0.29.0` is committed, tagged, pushed, and remote-verified
- Current local validation: V1-08 revision-promotion and release-packaging work
  passed local validation on `2026-07-04`
- Full pytest: `.venv/bin/python -m pytest` passed with `305 passed`
- Project checks: `.venv/bin/python run_checks.py --skip-pytest` passed for
  V1-08, including promoted preview/delivery render readiness, golden baseline,
  BGM/rhythm quality, and NLE round-trip readiness
- Release candidate: `.venv/bin/python scripts/run_release_candidate.py
  --allow-dirty --json` passed with status `warning` because local `runs/`
  real-project evidence remains visible and intentionally untracked; package
  preflight, canonical install simulation, quick validation, version target
  `0.29.0`, previous tag `v0.28.0`, and release ledger targeting all passed
- Targeted tests: V1-08 focused promote-revision tests, apply-revision
  regression tests, schema/gate/progress contract tests, and release-check
  tests passed; schema generation passed
