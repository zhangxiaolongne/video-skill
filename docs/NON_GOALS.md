...
The current V0-010i gate allows only proposal context preparation, text-model
...
mock handshake, no-call execution authorization, dry-run provider result envelope, readiness checks, and
