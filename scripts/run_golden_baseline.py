...
def run_pipeline(workspace: Path) -> dict:
    ...
    assert_equal(brief["edit_brief"]["duration_source"], "user_specified", "edit brief duration source")
    assert_equal(brief["edit_brief"]["requested_duration_seconds"], 3.0, "configured duration")
    assert_equal(brief["edit_brief"]["selected_option_id"], "user_specified", "configured duration option")
