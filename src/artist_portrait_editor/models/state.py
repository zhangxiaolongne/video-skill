...
def initial_steps() -> dict[str, StepLedgerEntry]:
    return {
        ...
        "fcpxml_repair_approval_request": StepLedgerEntry(),
        "fcpxml_repair_approval_record": StepLedgerEntry(),
        "fcpxml_repair_dry_run": StepLedgerEntry(),
        "fcpxml_repair_execution_review": StepLedgerEntry(),
    }
